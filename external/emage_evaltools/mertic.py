    ...
    def __init__(self, download_path="./emage/", device="cuda"):
        if download_path is not None:
            ...
            if not os.path.exists(model_file_path):
                print(f"Downloading {model_file_path}")
                wget.download(
                    "https://huggingface.co/H-Liu1997/emage_evaltools/blob/main/AESKConv_240_100.bin", #"https://huggingface.co/spaces/H-Liu1997/EMAGE/resolve/main/EMAGE/test_sequences/weights/AESKConv_240_100.bin",
                    model_file_path,
                )
            ...
            if not os.path.exists(smplx_model_file_path):
                ...
                wget.download(
                    "https://huggingface.co/H-Liu1997/emage_evaltools/blob/main/smplx_models/smplx/SMPLX_NEUTRAL_2020.npz",#"https://huggingface.co/spaces/H-Liu1997/EMAGE/resolve/main/EMAGE/smplx_models/smplx/SMPLX_NEUTRAL_2020.npz",
        ...
        old_stat = torch.load(download_path + "AESKConv_240_100.bin", weights_only=False)["model_state"]
        new_stat = {}
