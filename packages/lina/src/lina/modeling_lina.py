...
class LinaModel(nn.Module):
    ...
    def forward(self, x, y, encoder_mask, crossatt_mask, logits_mask=None, attention_only=False, forced_attention=None, init_state=None):
        # b: batch
        # n: seq length
        # q: quantizers
        # d: model dim
    ...
    def generate_batch(
        ...
        for t in tqdm(range(max_seqlen),leave=False):
